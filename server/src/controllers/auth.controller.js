...
export const handleRegistration = AsyncHandler(async (req, res, next) => {
    ...
    return res.status(201).json(
        new ApiResponse(true, 'User registered successfully.', { user: createdUser }, 201)
    );
});
...
export const handleLogin = AsyncHandler(async (req, res, next) => {
    ...
    return res.status(200).json(new ApiResponse(200, 'OTP sent successfully.', { user }, 200));
});
...
export const handleForgotPassword = AsyncHandler(async (req, res, next) => {
    ...
    return res.status(200).json(new ApiResponse(true, 'OTP sent successfully.', {}, 200));
})
...
export const handleResetPassword = AsyncHandler(async (req, res, next) => {
    ...
    return res.status(200).json(new ApiResponse(true, 'Password reset successfully.', {}, 200));
})
...
export const handleLogout = AsyncHandler(async (req, res, next) => {
    ...
    return res.status(200).json(new ApiResponse(true, 'Logged out successfully.', {}, 200));
})

export const handleAuthCheck = AsyncHandler((req, res) => {
    return res.status(200).json(new ApiResponse(true, 'Authenticated user!', { user: req.user }, 200));
});
...
export const handleGenerateNewAccessToken = AsyncHandler(async (req, res) => {
    ...
    return res.status(200).json(new ApiResponse(true, 'Tokens refreshed successfully.', { accessToken, user }, 200));
});
